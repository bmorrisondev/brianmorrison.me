  ...
  return (
    <div>
      ...
      <div className="min-h-screen">
        <div className="bg-gradient h-full md:m-8 md:rounded-xl p-8 mb-8">
          <div className="flex flex-col gap-2 text-center max-w-xl mx-auto">
            <div>Latest project • Mobile App</div>
      ...
      <div className="min-h-screen">
        ...
        <div className="flex flex-col gap-2 text-center max-w-xl mx-auto mb-2">
          <div>Applications • Infrastructure • Automation</div>
          ...
          <Link to="/work-with-me" className="flex justify-center gap-2 font-bold">View my full work history</Link>
        </div>
